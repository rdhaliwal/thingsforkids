...
(function($) {
  ...
  $(document).on('turbolinks:load', function() {
    ...
    function datetimepicker_init() {
      ...
      return $('.datepicker').on('dp.change', function(e) {
        var alt_field_id;
        alt_field_id = $(this).data('alt-field');
        if (e.date && alt_field_id) {
          return $("#" + alt_field_id).val(e.date.format('YYYY-MM-DD'));
        }
      });
    };
