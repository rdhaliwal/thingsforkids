Rails.application.configure do
  ...
  config.action_controller.asset_host = Rails.application.credentials.base_url
  ...
  # config.active_job.queue_name_prefix = "thingsforkids_#{Rails.env}"
  ...
  Rails.application.config.middleware.use ExceptionNotification::Rack,
    email: {
      email_prefix: "Error",
      sender_address: %{"notifier" <notifier@thingsforkids.com.au>},
